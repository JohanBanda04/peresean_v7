                                ...
                                <tr>
                                    ...
                                    <td align="center">
                                        <a href="<?php echo base_url($baris->lamp_surat_undangan);?>"
                                            <?php if ($baris->lamp_surat_undangan=="") {?> class="btn btn-info btn-xs hidden" <?php } else { ?> class="btn btn-info btn-xs "<?php } ?>  title="Download"
                                           download="">

                                            <!--LANJUTKAN UNTUK MENGHIDDEN TOMBOL DOWNLOAD DI TIAP PEMDA UTK LAPORAN HARMONISASI-->
